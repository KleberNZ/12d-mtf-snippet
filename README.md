...
The snippets included in this extension are derived from:

- **12d Model Manual – Section 19.7 (MTF syntax and commands)**

The goal is **authoring assistance**, not abstraction or simplification.
Snippets closely mirror the documented MTF syntax, using placeholders only where user input is required.
...
2. Ensure the modifiers behave exactly as intended
3. Use **Copy (paste snippet)** from 12d Model to generate a base `.mtfsnippet`
...
Always begin from working modifiers generated by 12d Model.
